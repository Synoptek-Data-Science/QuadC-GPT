...
CHUNK_BATCH_SIZE = PersistentConfig(
    "CHUNK_BATCH_SIZE", "rag.chunk_batch_size", int(os.environ.get("CHUNK_BATCH_SIZE", "50"))
)

EMBEDDING_BATCH_SIZE = PersistentConfig(
    "EMBEDDING_BATCH_SIZE", "rag.embedding_batch_size", int(os.environ.get("EMBEDDING_BATCH_SIZE", "100"))
)

VECTOR_INSERT_BATCH_SIZE = PersistentConfig(
    "VECTOR_INSERT_BATCH_SIZE", "rag.vector_insert_batch_size", int(os.environ.get("VECTOR_INSERT_BATCH_SIZE", "100"))
)

MAX_RETRIES = PersistentConfig(
    "MAX_RETRIES", "rag.max_retries", int(os.environ.get("MAX_RETRIES", "2"))
)
